<script>
 ...
 <div class="relative language-selector" style="z-index: 50;">
    <button 
        ...
        class="flex items-center space-x-2 px-4 py-2 rounded-lg border border-gray-900 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
    >
        <span class="flex items-center">
            {@html languages.find(lang => lang.code === currentLocale)?.flag}
        </span>
        ...
        >
            {#each languages as lang}
                ...
                >
                    ...
                    <span class="font-medium {currentLocale === lang.code ? 'text-blue-600' : 'text-gray-700'}">
                        {lang.name}
                    </span>
