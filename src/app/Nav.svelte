...
{#if innerWidth >= 1024}
  <div class="sait saix fixed left-0 right-0 top-0 z-nav">
    <div
      class="flex h-16 items-center justify-end gap-8 bg-neutral-900 pl-4 pr-8">
      <div class="relative">
        <div class="flex">
          <Input
            dark
...
<!-- bottom nav -->
{#if innerWidth < 1024}
  <div class="saib saix fixed bottom-0 left-0 right-0 z-nav">
    <div
      class="flex items-center justify-between rounded-t-xl border-neutral-600 bg-tinted-800 px-4 py-2 dark:bg-black">
      <div class="w-1/3">
        <div
